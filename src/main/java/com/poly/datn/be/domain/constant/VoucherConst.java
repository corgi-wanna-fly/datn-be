...
public class VoucherConst {
    ...
    public static final String API_VOUCHER_GET_BY_CODE = "/api/site/get-voucher-by-code";
    public static final String API_VOUCHER_CREATE = "/api/site/create-voucher";
    public static final String API_VOUCHER_UPDATE = "/api/site/update-voucher";
